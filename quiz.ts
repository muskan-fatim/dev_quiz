...
let total = 0;
let condition = true;
let q1 :string = "Tim Berners lee";
let q2 : string = "Nexus";
let q3 :string = "Hyber text markup language"
let q4 : string = "Cascading style sheet ";
let q5 : string = "Tim Berners lee";
let q6 : string = "node package manger";
let q7 : string = "Es2020"
let q8 : string = "??"
let q9 :string = "&nbsp;"
let q10 :string = "Document object model";
while(condition){
